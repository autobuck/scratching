...
public class Sprite {
  ...
  Sprite (PApplet parent) {
    ...
    costumes[0] = processing.loadShape("images/cat.costume1.png");
    costumes[1] = processing.loadShape("images/cat.costume2.png");
    costumeNumber=0;
    size=100;
  }
  ...
  public int distanceToSprite(Sprite target) { 
